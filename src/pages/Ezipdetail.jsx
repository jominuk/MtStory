      ...
      <Ezipcss.StBackground>
        ...
        <div>
          ...
          <div className="ezipContent">
            ...
            않고도 플렛폼을 통해 매물을 게시하고 후기를 작성한 후에 부동산과의
            계약을 편리하게 체결할 수 있는 방법을 제공합니다. 우리의 목표는
            진솔한 경험을 공유하며 부동산 시장에서 소비자와 판매자 양쪽에게
            도움이 되는 플랫폼을 구축하는 것입니다.이 플랫폼을 통해 사용자들은
            믿을 수 있는 정보와 솔직한 의견을 공유하며, 적합한 집을 찾는 데
            도움을 받을 수 있게 만들었습니다.
          </div>
        </div>
        ...
        <div>
          ...
          <Ezipcss.StWork>
            ...
            <div className="loginContent">
              <h3>◎ 커뮤니티 페이지 </h3>
              <p>
                ♣ 다양한 소통을 위한 페이지로 부동산 관련 내용 또는 사회 이슈 등
        ...
        <div>
          ...
          <div className="troubleBox">
            ...
            <div>1. 원인</div>
            <p className="trouble">
              "기존의 redux-toolkit에서 렌더링과 데이터 업데이트 형식에
